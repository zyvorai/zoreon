...
export function ChannelNav() {
  ...
  const active = useRelay((s) => s.activeChannelId);
  const setActive = useRelay((s) => s.setActiveChannel);
  const currentUserId = useRelay((s) => s.currentUserId);
  ...
  return (
    <aside className="flex h-full min-h-0 w-full max-w-full shrink-0 bg-sidebar md:w-60">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <div className="relay-scroll min-h-0 flex-1 px-2 py-3">
